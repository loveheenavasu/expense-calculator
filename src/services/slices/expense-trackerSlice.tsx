import { ExpenseFormData, IncomeFormData } from '@/components/types';
...
export const { addExpense, addIncome,deleteExpenseById,deleteIncomeById} = expenseTrackerSlice.actions
